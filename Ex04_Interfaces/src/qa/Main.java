...
public class Main {
    public static void main(String[] args) {
        ...
        //Testing Interface with Circles
        System.out.println("C before moving: " + c.getCurrentLocation());
        System.out.println("C2 before moving: " + c2.getCurrentLocation());
        c.move(10.5,4.3);
        System.out.println("C after moving: " + c.getCurrentLocation());
    }
}
